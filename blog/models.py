...
"""
    digest = models.CharField(verbose_name='摘要',max_length=200, blank=True) # 文章摘要
    def save(self, *args, **kwargs): #复写 save 方法获取摘要
        # 从 body 摘取前 54 个字符赋给到 digest
        self.digest = self.body[:54]
